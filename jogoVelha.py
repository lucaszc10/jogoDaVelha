...
class Game():
        ...
        def run_main_app(self):
                ...
                global theBoard, X_choose, O_choose
                theBoard = {'a1': '', 'a2': '', 'a3' : '', 'b1': '', 'b2': '', 'b3': '', 'c1': '', 'c2': '', 'c3' : ''}

                # Variáveis do tabuleiro / board and position variables
                global a1x, a1o, a2x, a2o, a3x, a3o, b1x, b1o, b2x, b2o, b3x, b3o, c1x, c1o, c2o, c2x, c2o, c3x, c3o
        ...
        def winner(self):
                ...
                if theBoard['a1'] != '' and theBoard['a2'] != '' and theBoard['a3'] != '':
                        if theBoard['a1'] == theBoard['a2'] == theBoard['a3']:
                                self.winner_page()
                if theBoard['a1'] != '' and theBoard['b1'] != '' and theBoard['c1'] != '':
                        if theBoard['a1'] == theBoard['b1'] == theBoard['c1']:
                                self.winner_page()
                if theBoard['a2'] != '' and theBoard['b2'] != '' and theBoard['c2'] != '':
                        if theBoard['a2'] == theBoard['b2'] == theBoard['c2']:
                                self.winner_page()
                if theBoard['a3'] != '' and theBoard['b3'] != '' and theBoard['c3'] != '':
                        if theBoard['a3'] == theBoard['b3'] == theBoard['c3']:
                                self.winner_page()
                if theBoard['b1'] != '' and theBoard['b2'] != '' and theBoard['b3'] != '':
                        if theBoard['b1'] == theBoard['b2'] == theBoard['b3']:
                                self.winner_page()
                if theBoard['c1'] != '' and theBoard['c2'] != '' and theBoard['c3'] != '':
                        if theBoard['c1'] == theBoard['c2'] == theBoard['c3']:
                                self.winner_page()
                if theBoard['a1'] != '' and theBoard['b2'] != '' and theBoard['c3'] != '':
                        if theBoard['a1'] == 'X' and theBoard['b2'] == 'X' and theBoard['c3'] == 'X':
                                self.winner_page()
                if theBoard['a1'] != '' and theBoard['b2'] != '' and theBoard['c3'] != '':
                        if theBoard['a3'] == 'X' and theBoard['b2'] == 'X' and theBoard['c1'] == 'X':
                                self.winner_page()
                else:
        ...
        def winner_page(self):
                while True:
                        ...
                        font_restart = pygame.font.SysFont("comicsans", 25)
                        text_restart1 = font_restart.render('Pressione ENTER para jogar novamente', True, (18, 10, 143))
                        text_restart2 = font_restart.render('ou ESC para sair', True, (18, 10, 143))
                        self.screen.blit(text_restart1, (self.width // 2 - (text_restart1.get_width() // 2), self.height - 50))
                        self.screen.blit(text_restart2, (self.width // 2 - (text_restart2.get_width() // 2), self.height - 30))                                        
